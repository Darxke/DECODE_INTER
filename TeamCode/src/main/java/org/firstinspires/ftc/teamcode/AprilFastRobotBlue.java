...
@Autonomous(name="3+3 Blue", group="Autonomous")
public class AprilFastRobotBlue extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action shoot = drive.actionBuilder(new Pose2d(59, -70, Math.toRadians(273)))
        ...
        Action shoot1 = drive.actionBuilder(new Pose2d(59, -70, Math.toRadians(273)))
                .strafeToLinearHeading(new Vector2d(58, -12), Math.toRadians(273))
                .build();
        ...
        Action shoot2 = drive.actionBuilder(new Pose2d(59, -66, Math.toRadians(273)))
                .strafeToLinearHeading(new Vector2d(58, -12), Math.toRadians(273))
                .build();
