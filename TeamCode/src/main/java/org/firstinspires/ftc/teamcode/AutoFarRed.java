...
public class AutoFarRed extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Action shoot = drive.actionBuilder(new Pose2d(31, 58, Math.toRadians(-260)))
        ...
        Action out = drive.actionBuilder(new Pose2d(59, 12, Math.toRadians(-195)))   // -35° → 325°
                .strafeToLinearHeading(new Vector2d(31, 25), Math.toRadians(-260))
                .build();

        Action cycle = drive.actionBuilder(new Pose2d(31, 25, Math.toRadians(-260)))
...
//                        new ProfileAccelConstraint(-10.0, 10.0)
        ...
        Action out2 = drive.actionBuilder(new Pose2d(59, 12, Math.toRadians(-195)))   // -35° → 325°
                .strafeToLinearHeading(new Vector2d(13, 26), Math.toRadians(-260))
                .build();

        Action cycle2 = drive.actionBuilder(new Pose2d(13, 21, Math.toRadians(-260)))
                .strafeToLinearHeading(
                        new Vector2d(13, 58),
                        Math.toRadians(-260)
//                        new TranslationalVelConstraint(20.0),
//                        new ProfileAccelConstraint(-10.0, 10.0)
                ...
                .build();
        Action shoot2 = drive.actionBuilder(new Pose2d(13, 58, Math.toRadians(-260)))
                .strafeToLinearHeading(new Vector2d(59, 12), Math.toRadians(-195))
                .build();
