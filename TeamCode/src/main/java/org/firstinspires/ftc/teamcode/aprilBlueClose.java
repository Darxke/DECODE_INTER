...
public class aprilBlueClose extends LinearOpMode {
    ...
    private static final double[] KICK_REST = {0, 0, 1.0};
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Pose2d startPose = new Pose2d(-52, -52, Math.toRadians(218));
        ...
        // ===== START INTAKE =====
        outtakeL.setVelocity(1100);
        outtakeR.setVelocity(1100);// RPM
        ...
        Action cycle2 = drive.actionBuilder(new Pose2d(-20,-22, Math.toRadians(218)))
                .strafeToLinearHeading(new Vector2d(15, -43), Math.toRadians(256))
                .waitSeconds(.1)
                .strafeToConstantHeading(new Vector2d(11, -81))
                .waitSeconds(.25)
                .build();
