...
public class TurrentCopy extends OpMode {
    ...
    private double targetX = -5.84; // Target is centered (tx = 0)
    ...
    private static final double MAX_POWER = 0.7; // Maximum turret speed
