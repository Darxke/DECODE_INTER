...
@Disabled
@Autonomous(name="April1", group="Autonomous")
public class AprilRedFar extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        Action cycle2 = drive.actionBuilder(new Pose2d(59, 12, Math.toRadians(-180)))
                ...
                .build();
        Action shoot2 = drive.actionBuilder(new Pose2d(5.5, 72, Math.toRadians(-273)))
                .strafeToLinearHeading(new Vector2d(59, 12), Math.toRadians(-180))
                .build();
