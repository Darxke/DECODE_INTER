...
@TeleOp(name = "ProTurretTracking", group = "Production")
public class ProTurretTracking extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            // Read IMU exactly once per loop — reused by handleTurret() and telemetry
